...
describe('[productsServices] createNewProduct', () => {
  ...
  describe('[productsServices] - "getAll" returns the products list from DataBase', () => {
  ...
  describe('[productsServices] - "getById" returns a product from DataBase', () => {
